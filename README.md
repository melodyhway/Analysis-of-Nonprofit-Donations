...
The data contains 1066 records on the donations made during the July 2024 - 2025 fiscal year. It contains the following columns:
...
# Dashboard Overview 
<img width="1998" height="1598" alt="offical dashboard (2) (1)" src="https://github.com/user-attachments/assets/42ffb39f-6f5e-4a29-8a3f-24a2e4acd34b" />
...
* We see similar fluctuation patterns. Notably, we see a peak in total donation volume in May and another peak in December. This can be explained by the hosted Chef Gala in May and common holiday operations in December.
...
* We see that there was a total of 181 donations made towards the Chef Gala accounting for 19% of donations made during May 2025. The other 81% are other donations at only 46 donations were not accounted for by the Chef Gala. This explains the unexpectedly high volume of donations that were fouund in May 2025 and the extra boost in donations during the month. It is likely that chef data donations were smaller amounts consistent with the smaller total despite high donation volume. 
...
* 80% of donations are covered by foundations at over $5M worth of donations
